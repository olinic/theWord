...
UBUNTU_TRANSLATION_DOMAIN="theword.otter"
...
aptest.commands = QML2_IMPORT_PATH=$$OUT_PWD/backend bash $$PWD/theWord/tests/autopilot/run
aptest.depends  = sub-theWord sub-backend-App

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/backend/tests/unit -import $$OUT_PWD/backend
unittest.commands += && /usr/bin/qmltestrunner -input $$PWD/theWord/tests/unit -import $$OUT_PWD/backend
unittest.depends  = sub-theWord sub-backend-App
